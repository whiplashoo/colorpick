...
'#800000', '#B0171F', '#DC143C', '#FFB6C1', '#FFAEB9', '#EEA2AD',
...
'#A0522D', '#FF8247', '#EE7942', '#CD6839', '#8B4726', '#FFA07A', '#8E388E', 
'#7171C6', '#7D9EC0', '#388E8E', '#71C671', '#8E8E38',
'#C5C1AA', '#C67171', '#555555', '#1E1E1E', '#282828', '#515151', '#5B5B5B',
'#848484', '#8E8E8E', '#AAAAAA', '#B7B7B7', '#C1C1C1', '#EAEAEA', '#F4F4F4',
'#FFFFFF', '#F5F5F5', '#DCDCDC', '#D3D3D3', '#C0C0C0', '#A9A9A9', '#808080',
'#696969', '#000000'] ;


function myInit(){
	for (var i =0 ; i<colors.length; i++) {
		$('#all').append('<div class="color" style="background-color:'+colors[i]+';width:60px;height:50px;float:left"></div');
	}

	$('.color').click(function() {
		$('#selected').append('<div class="selectedColors" style="background-color:'+$(this).css("background-color")+';width:60px;height:50px;float:left"></div');
	});
	$( "body" ).on( "click", ".selectedColors", function() {
		$(this).remove();
	});
	$('#finish').click(function(){
		var result = [];
		$('.selectedColors').each(function(){
			result.push(rgb2hex($(this).css("background-color"))+',');
